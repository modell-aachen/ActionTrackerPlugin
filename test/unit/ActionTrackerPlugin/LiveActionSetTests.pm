...
");
    ...
    Foswiki::Func::saveTopic($this->{users_web}, "Topic2", $meta, "
...
%ACTION{who=E,due=\"29 Jan 2001\",open}% Main_Topic2_E_open_ontime", { forcenewrevision=>1 });
    ...
    Foswiki::Func::saveTopic($this->{users_web}, "WebNotify", $meta, "
   * $this->{users_web}.C - sam\@sesame.street.com
", { forcenewrevision=>1 });
    Foswiki::Func::saveTopic($this->{users_web}, "B", $meta, "
   * Email: joe\@sesame.street.com
", { forcenewrevision=>1 });
    Foswiki::Func::saveTopic($this->{users_web}, "E", $meta, "
   * Email: joe\@sesame.street.com
...
sub test_GetAllInMain {
    ...
    my $actions = Foswiki::Plugins::ActionTrackerPlugin::ActionSet::allActionsInWeb($this->{users_web}, $attrs, 0);
...
sub test_GetAllInTest {
    my $this = shift;
    my $attrs = Foswiki::Attrs->new();
    my $actions = Foswiki::Plugins::ActionTrackerPlugin::ActionSet::allActionsInWeb($this->{test_web}, $attrs, 0);
    my $fmt = new Foswiki::Plugins::ActionTrackerPlugin::Format("", "", "", "\$text");
    my $chosen = $actions->formatAsString($fmt);
...
sub test_GetAllInAllWebs {
    ...
    my $actions = Foswiki::Plugins::ActionTrackerPlugin::ActionSet::allActionsInWebs($this->{users_web}, $attrs, 0);
    $actions->sort();
    my $fmt = new Foswiki::Plugins::ActionTrackerPlugin::Format("", "", "", '$text');
    my $chosen = $actions->formatAsString($fmt);
...
sub test_SortAllWebs {
    ...
    my $fmt = new Foswiki::Plugins::ActionTrackerPlugin::Format("", "", "", '$who $state $text');
    my $chosen = $actions->formatAsString($fmt);
...
sub test_AllTopicRE {
    ...
    my $actions = Foswiki::Plugins::ActionTrackerPlugin::ActionSet::allActionsInWebs($this->{test_web}, $attrs, 0);
    my $fmt = new Foswiki::Plugins::ActionTrackerPlugin::Format("", "", "", "\$text");
    my $chosen = $actions->formatAsString($fmt);
    $this->assert_does_not_match(qr/Test_Topic1_C_open_ontime/o, $chosen);
    $this->assert_matches(qr/Test_Topic2_A_open_late/o, $chosen);
